...
<body style="background-color: #6c4675">
    ...
    <?php
        ...
        while($row = mysqli_fetch_assoc($result)) {
            $dato = '"¿Desea eliminar el campo'.$row["Nombre"].'?"';
            echo '
            <tr>
                <td>'.$row["Nombre"].'</td>
                <td>'.$row["Matricula"].'</td>
                ...
                <td>
                    <a href="frmEdit.php?editar='.$row["IdCalificacion"].'" title="Editar campo">
                        <i class="bi bi-pencil-square"></i>
                    </a>
                </td>
                <td>
                    <a href="Delete.php?borrar='.$row["IdCalificacion"].'" title="Eliminar campo" class="text-danger" onclick="return confirm(\'¿Desea eliminar el campo '.$row["Nombre"].'?\');">
        ...
        <td>
            <form action="Edit.php" method="post">
                ...
                <button class="text-danger border-0 bg-transparent" title="Editar campo">
